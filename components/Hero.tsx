    ...
    <main className="bg-zinc-950 text-white">
      <section className="flex min-h-[calc(100vh-81px)] flex-col items-center justify-center px-6 text-center">
        ...
        <p className="mt-6 max-w-2xl text-lg text-zinc-400">
          Aracına uyumlu performans parçalarını keşfet,
          karşılaştır ve güvenilir satıcılardan satın al.
        </p>
        ...
        <div className="mt-8 flex flex-col gap-4 sm:flex-row">
          ...
          <button className="rounded-lg border border-zinc-700 px-6 py-3 font-semibold hover:bg-zinc-900">
            Aracını Seç
          </button>
        </div>
      </section>
